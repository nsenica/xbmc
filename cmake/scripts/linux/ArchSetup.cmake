...
if(WITH_ARCH)
  ...
  elseif(CPU STREQUAL cortex-a72)
    set(ARCH arm)
    set(NEON True)
    set(NEON_FLAGS "-fPIC -mcpu=cortex-a72")
...
if(CORE_PLATFORM_NAME_LC STREQUAL rbpi)
  ...
  elseif(CPU STREQUAL cortex-a72)
    set(NEON_FLAGS "-fPIC -mcpu=cortex-a72 -march=armv8-a+crc+simd -mfloat-abi=hard -mfpu=neon-fp-armv8 -mvectorize-with-neon-quad")
  endif()
endif()
